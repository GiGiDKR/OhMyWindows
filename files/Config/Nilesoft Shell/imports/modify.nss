...
modify(find='WizTree' menu=title.more_options)
modify(find='Glary Utilities' menu=title.more_options)
modify(find='VLC' menu=title.more_options)
modify(find='Take Ownership' menu=title.more_options)
modify(find='Synchroniser' menu=title.more_options)